 ...
 * 
 */
package um.facultad.rest.hexagonal.inscripciones.inscripcionPago.infrastructure.persistence.entity;
...
@NoArgsConstructor
@AllArgsConstructor
public class InscripcionPagoEntity implements Serializable {
	/**
	 * 
	 */
	@Serial
