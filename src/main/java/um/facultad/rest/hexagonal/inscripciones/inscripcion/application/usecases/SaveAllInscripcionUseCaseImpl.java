...
import um.facultad.rest.hexagonal.inscripciones.inscripcion.domain.ports.in.SaveAllInscripcionUseCase;
...
public class SaveAllInscripcionUseCaseImpl implements SaveAllInscripcionUseCase {

    private final InscripcionRepository inscripcionRepository;

    @Override
    public List<Inscripcion> saveAll(List<Inscripcion> inscriptos) {
        return inscripcionRepository.saveAll(inscriptos);
    }
