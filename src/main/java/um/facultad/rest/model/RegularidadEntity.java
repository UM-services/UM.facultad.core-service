...
@Setter
@Entity
@Table(name = "regularidad", uniqueConstraints = { @UniqueConstraint(columnNames = { "iddocumento", "idtipodoc", "idlectivo", "idfacultad",
		"idplan", "idmateria" }) })
@NoArgsConstructor
@AllArgsConstructor
public class RegularidadEntity implements Serializable {
	/**
	 * 
	 */
	@Serial
