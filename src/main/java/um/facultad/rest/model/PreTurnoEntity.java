...
@Setter
@Entity
@Table(name = "pre_turno", uniqueConstraints = { @UniqueConstraint(columnNames = { "ptu_fac_id", "ptu_lec_id", "ptu_geo_id", "ptu_id" }) })
@NoArgsConstructor
@AllArgsConstructor
public class PreTurnoEntity implements Serializable {
	/**
	* 
	*/
	@Serial
