...
@Setter
@Entity
@Table(name = "pre_inscripcion", uniqueConstraints = { @UniqueConstraint(columnNames = { "pin_fac_id", "pin_per_id", "pin_doc_id" }) })
@NoArgsConstructor
@AllArgsConstructor
public class PreInscripcionEntity implements Serializable {
	/**
	 * 
	 */
	@Serial
